...
Я — голосовой бот. Напиши мне текст, или запиши голосовое сообщение и я его переозвучу другим голосом.
<br />
Я умею создавать голосовые сообщения с эмоциональной интонацией и добавлять фоновый шум.


🔹 <b>При записи голосового сообщения</b> используйте невербальные звуки (предыхание, смех, покашливание) для лучшей интонации.
